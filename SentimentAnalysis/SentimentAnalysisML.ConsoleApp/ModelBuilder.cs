...
namespace SentimentAnalysisML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\gitenv\MLNET\SentimentAnalysis\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../SentimentAnalysisML.Model/MLModel.zip";
